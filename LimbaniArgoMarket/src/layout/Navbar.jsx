        ...
        <nav className="bg-surface/80 dark:bg-surface-dim/80 backdrop-blur-lg fixed top-0 w-full z-50 border-b border-outline-variant/30 dark:border-outline/20 shadow-sm transition-all">
            <div className="flex justify-between items-center px-margin-desktop py-4 max-w-container-max mx-auto">
                ...
                <div className="hidden md:flex gap-6 items-center">
                    ...
                    <NavLink to="/dealers" className={({ isActive }) => `font-body-md text-body-md hover:bg-surface-container-low dark:hover:bg-surface-container-highest rounded px-2 py-1 active:scale-95 duration-200 cursor-pointer ${isActive ? 'text-primary dark:text-primary-fixed-dim font-bold bg-primary/10' : 'text-on-surface-variant dark:text-on-tertiary-container hover:text-primary transition-colors'}`}>Dealers</NavLink>
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden bg-surface dark:bg-surface-dim border-t border-outline-variant/30 px-margin-mobile py-4 shadow-lg absolute w-full left-0 top-full flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <NavLink to="/dealers" className={({ isActive }) => `font-body-md text-body-md rounded px-2 py-2 ${isActive ? 'text-primary font-bold bg-primary/10' : 'text-on-surface-variant hover:bg-surface-container-low'}`}>Dealers</NavLink>
