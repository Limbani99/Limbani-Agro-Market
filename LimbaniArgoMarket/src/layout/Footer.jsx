...
const Footer = () => {
    return (
        <footer className="bg-surface-container-highest dark:bg-surface-dim w-full py-stack-lg border-t border-outline-variant dark:border-outline flat no shadows mt-12">
