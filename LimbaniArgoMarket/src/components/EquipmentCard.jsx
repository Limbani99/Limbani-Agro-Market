...
const EquipmentCard = ({ equipment }) => {
    return (
        <div className="bg-surface rounded-2xl card-shadow overflow-hidden group flex flex-col h-full border border-outline-variant/30">
            <div className="relative h-32 sm:h-44 md:h-48 bg-surface-container overflow-hidden">
            ...
            <div className="p-3 sm:p-4 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-1 sm:mb-2">
                    <h3 className="font-title-md text-xs sm:text-title-md text-on-surface line-clamp-2">{equipment.name}</h3>
                ...
                <p className="font-headline-lg-mobile text-sm sm:text-headline-lg-mobile text-primary-container mb-2 sm:mb-4">{equipment.price}</p>
                <div className="hidden sm:flex gap-4 mb-4 border-b border-outline-variant/20 pb-4">
