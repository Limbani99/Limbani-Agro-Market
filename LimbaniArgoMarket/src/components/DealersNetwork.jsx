...
const DealersNetwork = () => {
    return (
        <section className="py-12 md:py-20 bg-surface-bright border-y border-outline-variant/20">
            <div className="max-w-container-max mx-auto px-4 sm:px-margin-mobile md:px-margin-desktop">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
                    <div className="bg-surface rounded-2xl border border-outline-variant p-5 md:p-6 flex flex-col">
                    ...
                    <div className="bg-surface-bright rounded-2xl border-2 border-secondary-container p-5 md:p-6 flex flex-col relative transform sm:-translate-y-2 md:-translate-y-4 shadow-lg">
